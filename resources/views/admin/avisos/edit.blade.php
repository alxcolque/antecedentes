...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" action="{{ route('admin.avisos.update',$aviso->id)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="row bg-light text-dark">
                ...
                <div class="col-md-6 mt-2">
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{$aviso->titulo}}" placeholder="Ingrese el titulo del post" name="titulo" type="text" id="titulo" required onkeyup="this.value = this.value.toUpperCase();">
                    </div>
                    @error('titulo')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Descripcion breve" id="descripcion" name="descripcion" required>{{$aviso->descripcion}}</textarea>
                    </div>
                    @error('descripcion')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                ...
                <div class="col-md-6 mt-2">
                    <div class="card bg-light text-dark">
                        ...
                        <div class="card-body">
                            ...
                            <img id="idimag" class="profile-user-img img-fluid" src="{{ asset ('/storage/avisos/'.$aviso->imagen)}}" alt="User profile picture">
                        </div>
