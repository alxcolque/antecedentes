...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal" action="{{ route('admin.carruseles.update',$carrusele->id)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="row bg-light text-dark">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{$carrusele->image}}" placeholder="Nombre de la imagen" name="image" id="image" readonly required>
                    </div>
                    @error('image')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                ...
                <div class="col-md-6 mt-2">
                    <div class="card bg-light text-dark">
                        ...
                        <div class="card-body">
                            ...
                            <img id="idimag" class="profile-user-img img-fluid" src="{{ asset ('/storage/carruseles/'.$carrusele->image)}}" alt="User profile picture">
                        </div>
